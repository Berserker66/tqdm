...
class ImportManager:
    ...
    def _import_hook(self, fqname, globals=None, locals=None, fromlist=None, unknown_arg=None):
...
class Importer:
    ...
    def _process_result(self, tupl, fqname):
        ispkg, code, values = tupl
